...
> **Новое в v1.3.4** — подготовительный релиз: провод не изменился (по-прежнему MCP `2025-11-25`), закрыта упаковка пакета и подняты зависимости. Подробности — в [CHANGELOG](./CHANGELOG.md).
