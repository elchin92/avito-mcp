...
> **New in v1.3.4** — a preparatory release: the wire is unchanged (still MCP `2025-11-25`), packaging is locked down, and dependencies are lifted. See the [CHANGELOG](./CHANGELOG.md) for details.
